...
$lang = array_merge(
	...
	'PRELELEASE_TITLE' => 'Your %s is a pre-release version.',
	...
	'BBGUILDSCRIPTALERT' => 'bbGuild includes embedded Javascript. You are invited to use a javascript-enabled browser.',
	...
	'FV_REQUIRED_GAME_NAME' => 'A game name is required.',
	'FV_REQUIRED_GAME_ID' => 'A game ID is required (minimum 2 characters).',
	'FV_REQUIRED_FACTION_NAME' => 'A faction name is required.',
	'FV_REQUIRED_ROLE_NAME' => 'A role name is required.',
	'FV_REQUIRED_RACE_NAME' => 'A race name is required.',
	'FV_REQUIRED_RACEID' => 'A numeric race ID is required.',
	...
	'BBGUILD_WELCOME' => 'bbGuild Admin Dashboard',
	...
	'RETURN_LOG'  => 'Return to activity log',
	...
	'ACP_BBGUILD_LOGS_EXPLAIN' => 'Audit log of all administrative actions performed in bbGuild. Click column headers to sort.',
	...
	'ACP_LISTGUILDS_EXPLAIN' => 'Overview of all guilds managed in bbGuild. You must create at least one guild before you can add players. Click a guild name or the edit icon to change its settings.',
	'ACP_ADDGUILD_EXPLAIN' => 'Create a new guild. Select the game, enter the guild name and realm, then choose a region and faction. WoW and GW2 guilds will automatically download the guild emblem from Battle.NET / ArenaNet.',
	'ACP_EDITGUILD_EXPLAIN' => 'Edit guild settings, manage API sync, or delete this guild.',
	...
	'ACP_MM_ADDPLAYER_EXPLAIN' => 'Add a new player or edit an existing one. Set the character name, guild, rank, game, class, race, and role.',
	...
	'ACP_BBGUILD_CONFIG_EXPLAIN' => 'Configure the general settings for your guild management system, including roster display, messages, and news.',
	...
	'ACP_LISTRACE_EXPLAIN' => 'Races are the species or character origins available in the game (e.g. Human, Elf, Dwarf). Each race belongs to a faction.',
	'ACP_LISTCLASS_EXPLAIN' => 'Classes are the character professions or archetypes available in the game (e.g. Warrior, Mage, Priest).',
	'ACP_GAMESETTINGS_EXPLAIN' => 'Configure general settings and manage all game data: factions, races, roles, and classes.',
	'ACP_LISTFACTIONS_EXPLAIN' => 'Factions are the teams or sides that players can belong to (e.g. Alliance vs. Horde, Republic vs. Empire).',
	'ACP_ADDCLASS_EXPLAIN' => 'Define a new class or edit an existing one. Classes are the character professions or archetypes in the game (e.g. Warrior, Mage).',
	'ACP_ADDFACTIONS_EXPLAIN' => 'Define a new faction or edit an existing one. Factions are the teams or sides in the game.',
	'ACP_ADDRACE_EXPLAIN' => 'Define a new race or edit an existing one. Races are the species or origins a character can be (e.g. Human, Elf).',
	'ACP_ADDRANK_EXPLAIN' => 'Add or edit guild ranks. For WoW guilds, ranks can be downloaded from the Armory API. Ranks 90 (Guildless) and 99 (Unknown) are system ranks and cannot be edited.',
	...
	'ACP_ROLES_EXPLAIN' => 'Roles describe a character’s combat function in a group (e.g. Tank, Healer, Damage Dealer).',
	'ACP_LISTRECRUITS_EXPLAIN' => 'Here you can add or edit Recruitments',
	'ACP_LISTGAME_EXPLAIN' => 'Manage game settings and data',
	...
	'ACP_NEWGAME_EXPLAIN' => 'Here you can install preconfigured games from enabled game plugins, create your own custom game, or manage your installed games.',
	'ACP_EDITGAME_EXPLAIN' => 'Here you can edit the building blocks of a game: factions (teams/sides), races (species/origins), roles (combat functions like Tank or Healer), and classes (character professions/archetypes).',
	'ACP_GAME_EXPLAIN' => 'Reset reinstalls default data for this game. Delete removes the game and all its data permanently.',
	'ACP_GAME_RESET' => 'Reset to defaults',
	'ACP_GAME_DELETE' => 'Permanently delete this game',
	...
	'ADMIN' => 'Admin',
	'DEFAULT_LANGUAGE' => 'Game Data Language',
	'DEFAULT_LANGUAGE_EXPLAIN' => 'Language used for translated game data such as class names, race names, and boss names.',
	...
	'GENERAL_SETTINGS' => 'bbGuild Settings',
	'HIDE_INACTIVE' => 'Hide Inactive Players',
	'HIDE_INACTIVE_NOTE' => 'When enabled, players marked as inactive will be hidden from the guild roster.',
	...
	'LISTPLAYERS_PER_PAGE_EXPLAIN' => 'Number of players to show per page on the roster and player lists.',
	...
	'FREQ1'    => 'Weeks',
	'FREQ2'    => 'Months',
	'BBGUILD_STARTED' => 'Guild Start Date',
	'BBGUILD_STARTED_EXPLAIN' => 'The date your guild management system was set up. Used as the starting point for statistics.',
	'ATTENDANCEDAYS' => 'Attendance days (for Standings)',
	'MAX_NUMBER_CHARS_EXPLAIN' => 'Maximum number of game characters a forum user can add or claim via the User Control Panel.',
	'MAX_NUMBER_CHARS' => 'Max Characters per User',
	'PARSETAGS' => 'Guildtags to Parse',
	'PARSETAGS_NOTE' => 'Those listed will be available as options when parsing raid logs.',

	// Game Management
	'GAME_CLASSRACEUPDATE_EXPLAIN' => 'The game assignment is fixed and cannot be changed after creation.',
	'GAME_NAME_EXPLAIN' => 'The display name of the game (e.g. "World of Warcraft")',
	'DOWNLOAD'   => 'Download',
	...
	'PLUGINS_INSTALLED' => 'Game Plugins',
	'PLUGINS_STATUS' => 'Status',
	'PLUGIN_UP_TO_DATE' => 'Up to date',
	'ADD_GAME' => 'Custom game installation',
	'ADD_PRECONFIGGAME' => 'Install from game plugin',
	'ADD_CUSTOMGAME' => 'Create custom game',
	'LIST_GAMES' => 'List Games',
	'GAMES_INST' => 'Games installed',
	'INSTALL' => 'Install',
	'GAME_IMAGE_EXPLAIN' => 'PNG filename without extension. The file must exist in images/gameworld/%s.',
	'UNINSTALL' => 'Uninstall',
	'MIN' => 'Min ',
	'MAX' => 'Max ',
	...
	'FACTION_NAME_EXPLAIN' => 'The name of this faction or team (e.g. Alliance, Horde, Republic).',

	// Races
	'RACEID_EXPLAIN' =>'A unique numeric identifier for this race. Cannot be changed after creation.',
	'RACE_EXPLAIN' =>'Enter the name of the race (e.g. Human, Elf, Dwarf).',
	'EDIT_RACE_TITLE' => 'Edit a Race',
	'ADD_RACE_TITLE' => 'Race Details',
	'ADD_RACE' => 'Add Race',
	'UPDATE_RACE' => 'Update Race',
	'RACE_IMAGE' => 'Race Icon',
	'RACE_IMAGE_EXPLAIN' => 'PNG filename without extension. The file must exist in the game’s race_images folder.',

	// Classes
	'CLASS_ID_EXPLAIN' => 'A unique numeric identifier for this class. Cannot be changed after creation.',
	'CLASS_ARMORY_EXPLAIN' => 'The armor weight category this class can wear (e.g. Cloth, Leather, Plate).',
	'CLASS_IMAGE_EXPLAIN' => 'PNG filename without extension. The file must exist in the game’s class_images folder.',
	'CLASS_COLOR_EXPLAIN' => 'Choose a display color for this class. Used in the roster and player lists.',
	'ADD_CLASS_TITLE' => 'Class Details',
	'ADD_CLASS' => 'Add Class',
	'UPDATE_CLASS' => 'Update Class',
	'CLASS_NAME' => 'Class Name',
	'CLASS_ID' => 'Class ID',
	'CLASS_ARMORY' => 'Armor Type',
	'CLASS_IMAGE' => 'Class Icon',
	'CLASS_COLOR' => 'Display Color',
	'CLASS_LEVEL' => 'Level Range',
	...
	'ROLE_COLOR_EXPLAIN' => 'A hex color code (e.g. #FF0000) used to display this role in lists.',
	'ROLE_ICON' => 'Role Icon',
	'ROLE_ICON_EXPLAIN' => 'Icon filename for this role, shown in the roster.',
	'ROLE_NAME' => 'Role Name',
	'ROLE_NAME_EXPLAIN' => 'The name of this role (e.g. Tank, Healer, Damage Dealer).',
	'ROLE_ID' => 'Role ID',
	'ROLE_CAT_ICON' => 'Category Icon',
	'ROLE_CAT_ICON_EXPLAIN' => 'Icon used for the role category grouping.',

	// Guild Management
	'ARMORY_ENABLED_EXPLAIN' => 'Enable the game API to automatically sync character data from the game server.',
	'ARMORY_ENABLED_GUILD_EXPLAIN' => 'Enable API sync for this specific guild. The game-level API setting must also be enabled.',
	...
	'GUILD_EMBLEM_EXPLAIN' => 'PNG image, stored in files/bbguildwow/emblems/',
	...
	'ARM_LAYOUTDO' => 'Roster Layout',
	'ARM_LAYOUTDO_EXPLAIN' => 'Standard shows all players in a flat list. Class view groups players by their class.',
	'ARM_STAND' => 'Standard (flat list)',
	'ARM_CLASS' => 'Grouped by class',
	'SHOWONROSTER' => 'Show on Roster',
	'MINLEVELROSTER' => 'Minimum Level for Roster',
	'MINLEVELROSTER_EXPLAIN' => 'Players below this level will be hidden from the guild roster.',
	...
	'NEWSBLOCKSETTING' => 'News Block',
	'NEWSFORUM' => 'News forum :',
	'NEWSNUMBER' => 'News Items to Display',
	'NEWSNUMBER_EXPLAIN' => 'How many recent news posts to show on the guild welcome page.',
	'LOOTBLOCKSETTING' => 'Loot block Settings',
	'SHOWLOOTBLOCK' => 'Show loot block:',
	'NUMBITEMS' => 'Number of items :',
	'BOSSBLOCKSETTING' => 'Boss Progress Block',
	'SHOWBOSSBLOCK' => 'Show Boss Progress',
	'SHOWBOSSBLOCKNOTE' => 'Display the boss kill progression block on the guild page. Requires the Gameworld extension.',
	...
	'MOTDGREETING' => 'Welcome to our guild',
	'MOTD' => '[b]Welcome to our Guild[/b]! Please change your welcome message in the ACP.',
	'SHOW_MOTD' => 'Show Message of the Day',
	'BLOCK_MOTD' => 'Message Text',
	'BLOCK_MOTD_SETTING' => 'Message of the Day',
	'BLOCK_MOTD_EXPLAIN' => 'Enter a welcome message or announcement for your guild members. BBCode formatting is supported.',
	...
	'ZONEBASEURL_EXPLAIN' => 'Base URL for linking zone/dungeon names to an external database (e.g. Wowhead).',
	'BOSSBASEURL' => 'Boss Database URL',
	'BOSSBASEURL_EXPLAIN' => 'Base URL for linking boss names to an external database (e.g. Wowhead).',
	'RAIDS' => 'Raids',
...
So the loot would go to player 2 <br />',
	...
	'ERROR_GAME_HAS_GUILDS' => 'Cannot delete game "%s". There are %d guild(s) using this game. Delete the guilds first.',
	'ERROR_GAME_HAS_PLAYERS' => 'Cannot delete game "%s". There are %d player(s) using this game. Delete the players first.',
	'ERROR_GAME_EXISTS' => 'A game with ID "%s" already exists.',
	...
	'ADMIN_LOG_DELETE_SUCCESS' => 'The log entries %s were deleted successfully.',
	'ADMIN_LOG_DELETE_FAIL' => 'The log entries %s were not deleted.',
	...
	'ADMIN_DELETE_RACE_FAILED' => 'You can’t delete race %s because it has players.',
	'ADMIN_DELETE_CLASS_SUCCESS' => 'Class %s deleted successfully.',
	'ADMIN_DELETE_CLASS_FAILED' => 'You can’t delete class %s because there are members in it.',
	...
	'NUMBER_OF_PLAYERS' => 'Players (Active / Inactive)',
