...
- **Milestone scheme (GitHub, milestone-driven versioning — no version labels):**
  ...
  - `2.3.0` (due 2027-01-15) — **bbGuild API surface (#370: phpBB events + read API)** — the integration layer for the family (revives 2012 bbDKP-API idea), Discord (new ext, open question, not decided), Gameworld port (existing repo, old phpBB 3.0 MOD → 3.3 extension, `Gameworld#16`, milestoned 2.3.0), Battle.net API modernisation, spec build analysis (#286).
